...
def view_plots(output_data):
    ...
    plt.scatter(jumping_data['total_var_val'], jumping_data['total_mean_val'], c='orange', label='Jumping')
    plt.scatter(walking_data['total_var_val'], walking_data['total_mean_val'], c='blue', label='walking')
    plt.xlabel('VAR')
    plt.ylabel('MEAN')
